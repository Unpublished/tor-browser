...
# TBA: MOZ_XULRUNNER, MOZ_CAPTURE, MOZ_RAW defines are dead/unused, leaving here for easier future rebasing
...
# Disables support at compile-tile for casting (Mozilla Media Manager)
# and dependency on Google Play Services support
